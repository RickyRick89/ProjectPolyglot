...
class Net(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(20 * 12*12, 1000)                       # FC 20x12x12 to 300 neurons                   
        self.fc2 = nn.Linear(1000, 250)                              # FC 300 to 150 neurons
        self.fc3 = nn.Linear(250, 100)                              # FC 300 to 150 neurons
        self.fc4 = nn.Linear(100,7)                                 # 150 to 7 neurons to form logits
    def forward(self, x):
