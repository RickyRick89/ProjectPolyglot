...
;~ _ArrayDisplay($aTagSheet)
	...
	For $iRow = 1 To UBound($aMISheet) - 1
		...
		Switch $sLine
			Case '1'
				$sPLCWinTitle = 'Logix Designer - MOS_L01_CLX'
			Case '2'
				$sPLCWinTitle = 'Logix Designer - MOS_L02_CLX'
			Case Else
...
;~ If $sPLCWinTitle = 'Logix Designer - CA_PROC_5B' Then ContinueLoop
		...
		$sImportFilePath = 'X:\2022_MosesLake\SystemIntegrator\_Shared\PLC_HMI_Code\RichardGroves_Sandbox\Imports\Line' & $sLine & '\' & $sUnit & '\' & $sName & '.L5X'
