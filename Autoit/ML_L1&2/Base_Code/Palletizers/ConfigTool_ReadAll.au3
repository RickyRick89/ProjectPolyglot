...
HotKeySet('{esc}', '_Exit')
$iPID = Run("C:\Program Files (x86)\AutoIt3\AutoIt3.exe " & @ScriptDir & "\PopupCloser.au3")

$sConfigToolWorkbookPath = "X:\2022_MosesLake\SystemIntegrator\_Shared\PLC_HMI_Code\RichardGroves_Sandbox\ConfigTools\PCK_ConfigTool_20230703.xls"
