...
$sMIWorkbookPath = "X:\2022_Grand_Forks\SystemIntegrator\_Shared\PLC_HMI_Code\RichardGroves_Sandbox\Motor And Instrument List Rev 0.1.xlsx"
...
;~ If $sPLCWinTitle = 'Logix Designer - CA_PROC_5B' Then ContinueLoop
		...
		If $sType = 'YaskawaVSD' Or $sType = 'Motor' Then
