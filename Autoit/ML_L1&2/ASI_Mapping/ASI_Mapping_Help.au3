...
$sWorkbookPath = "C:\Users\rgrov\OneDrive - Bit-Wise Automation LLC\Richards_Docs\My_Scripts\ML_L1&2\ASI_Mapping\L01_ASI_Addresses_20230311.xlsx"
$sBaseTextpath = "C:\Users\rgrov\OneDrive - Bit-Wise Automation LLC\Richards_Docs\My_Scripts\ML_L1&2\ASI_Mapping\ASI_Mapping_Help-BaseText.L5x"
...
For $x = 1 To UBound($aSheet) - 1
	...
	$sSubNode = $aSheet[$x][6]
	ConsoleWrite(@CRLF & '==============> ' & $sMasterName & '-' & $sSegment & '-' & $sNodeAddress & '-' & $sSubNode)
	...
	$iYIRefStart = $iYPos + 80
	$iXORefStart = $iXPos + 200
	$iYORefStart = $iYPos + 80
