...
$sPIDPath = "C:\Users\rgrov\OneDrive - Bit-Wise Automation LLC\Richards_Docs\My_Scripts\GFK_L4\Audit\GFP Process Support PID Complete Set-8-9-2023.pdf"
$sSheetName = 'Instrument List'
$sWinTitlePID = 'GFP Process Support PID Complete Set-8-9-2023.pdf'
...
$oWorksheet = $oWorkbook.Sheets($sSheetName)
...
For $iInc = 1 To UBound($aSheet) - 1
	...
	Else
		...
		$sSearch = $sType & ' ' & $sTag
	EndIf
	$iColor = $oWorksheet.Cells($iInc + 1, 2).Interior.Color

	If $iColor = 13561798 Then ContinueLoop
