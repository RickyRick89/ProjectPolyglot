...
RunWait(@AutoItExe & ' "' & @ScriptDir & '\Main_Cleanup.au3"')
...
;~ _ArrayDisplay($aTagSheet)
	...
	For $iRow = 1 To UBound($aMISheet) - 1
		...
		EndIf
		$sTagsFile = "X:\2022_Grand_Forks\SystemIntegrator\_Shared\PLC_HMI_Code\RichardGroves_Sandbox\Exports\Use_Files\" & $sType & "_Tags.xml"
		$sRungsFile = "X:\2022_Grand_Forks\SystemIntegrator\_Shared\PLC_HMI_Code\RichardGroves_Sandbox\Exports\Use_Files\" & $sType & "_Rungs.xml"
...
;~~~~~~~~~~~~~~~~~ Data Types ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		$aReplaceInfo[$iArrayIndex][1] = FileRead("X:\2022_Grand_Forks\SystemIntegrator\_Shared\PLC_HMI_Code\RichardGroves_Sandbox\Exports\Use_Files\DTs.xml")

;~~~~~~~~~~~~~~~~~ AOIs ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		$aReplaceInfo[$iArrayIndex][2] = FileRead("X:\2022_Grand_Forks\SystemIntegrator\_Shared\PLC_HMI_Code\RichardGroves_Sandbox\Exports\Use_Files\AOIs.xml")
...
;~ _ArrayDisplay($aReplaceInfo)
	...
	For $x = 1 To UBound($aReplaceInfo) - 1
		$sFilePath = 'X:\2022_Grand_Forks\SystemIntegrator\_Shared\PLC_HMI_Code\RichardGroves_Sandbox\Imports\Main_' & $aReplaceInfo[$x][0] & '.L5X'
