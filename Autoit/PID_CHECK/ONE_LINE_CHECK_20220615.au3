...
$sWorkbookPath = "C:\Users\rgrov\RJX AUTOMATION LLC\Raul Barrios - Simplot\2021_Caldwell_L5_Fry\SystemIntegrator\_Shared\PLC_HMI_Code\RichardGroves_Sandbox\Jeremys_M&I.xlsx"

$sPIDPath = "C:\Users\rgrov\OneDrive - Bit-Wise Automation LLC\Richards_Docs\My_Scripts\PID_CHECK\CLD_EIC_ONE_LINE_DRAWINGS_20220429_v1.pdf"
$sSheetName = 'Instruments'
$sWinTitlePID = 'CLD_EIC_ONE_LINE_DRAWINGS_20220429_v1.pdf'
...
;~ 	$sType = 'EC'
	...
	If $bFound Then
		$oWorkbook.Sheets($sSheetName).Range('A' & $iInc + 1).Style = "Good"
...
;~ 			$oWorkbook.Sheets($sSheetName).Range('E' & $iInc + 1).Value = InputBox('Description', 'Description', $sDescription)
;~ 		EndIf
	Else
		$oWorkbook.Sheets($sSheetName).Range('A' & $iInc + 1).Style = "Bad"
	EndIf
