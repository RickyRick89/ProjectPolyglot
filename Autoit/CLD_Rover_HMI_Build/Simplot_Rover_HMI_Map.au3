...
$sGridTemplate = FileRead("C:\Users\rgrov\OneDrive - Bit-Wise Automation LLC\Richards_Docs\My_Scripts\CLD_Rover_HMI_Build\Grid_Template.xml")
$sRoverZoneTemplate = FileRead("C:\Users\rgrov\OneDrive - Bit-Wise Automation LLC\Richards_Docs\My_Scripts\CLD_Rover_HMI_Build\Zone_Template.xml")
$sStandZoneTemplate = FileRead("C:\Users\rgrov\OneDrive - Bit-Wise Automation LLC\Richards_Docs\My_Scripts\CLD_Rover_HMI_Build\Stand_Template.xml")
$sStandLabelTemplate = FileRead("C:\Users\rgrov\OneDrive - Bit-Wise Automation LLC\Richards_Docs\My_Scripts\CLD_Rover_HMI_Build\Zone_Label_Template.xml")
$sVBATemplate = FileRead("C:\Users\rgrov\OneDrive - Bit-Wise Automation LLC\Richards_Docs\My_Scripts\CLD_Rover_HMI_Build\Button_VBA_Template.vb")

$sRootPath = 'C:\Users\rgrov\OneDrive - Bit-Wise Automation LLC\Richards_Docs\My_Scripts\CLD_Rover_HMI_Build\'
$sNewFileSub = 'map_7_'    ;<<<<<<<<---------Change
$iRowLL = 81                ;<<<<<<<<---------Change
$iRowUL = 95             ;<<<<<<<<---------Change
$iColumnLL = 1             ;<<<<<<<<---------Change
$iColumnUL = 35         ;<<<<<<<<---------Change
...
_FileCreate($sRootPath & $sNewFileSub & 'NewGrids.xml')
_FileCreate($sRootPath & $sNewFileSub & 'NewRoverZones.xml')
_FileCreate($sRootPath & $sNewFileSub & 'NewStandZones.xml')
_FileCreate($sRootPath & $sNewFileSub & 'NewStandLabels.xml')
_FileCreate($sRootPath & $sNewFileSub & 'NewVBA.vb')

FileWrite($sRootPath & $sNewFileSub & 'NewGrids.xml', $sNewGrids)
FileWrite($sRootPath & $sNewFileSub & 'NewRoverZones.xml', $sNewRoverZones)
FileWrite($sRootPath & $sNewFileSub & 'NewStandZones.xml', $sNewStandZones)
FileWrite($sRootPath & $sNewFileSub & 'NewStandLabels.xml', $sNewStandLabels)
FileWrite($sRootPath & $sNewFileSub & 'NewVBA.vb', $sNewVBA)
