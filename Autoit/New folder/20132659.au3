...
$oSheet = _Excel_SheetAdd($oWorkbookNew)
_Excel_RangeWrite($oWorkbookNew, $oSheet, $aResults)
_Excel_BookSaveAs($oWorkbookNew, 'C:\Users\rgrov\OneDrive - Bit-Wise Automation LLC\Richards_Docs\My_Scripts\New folder\' & $iEnd & 'xlsx')
