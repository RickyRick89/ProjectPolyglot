...
;~ _ArrayDisplay($aTagSheet)
	...
	For $iRow = 1 To UBound($aMISheet) - 1
		...
		EndIf
;~~~~~~~~~~~~~~~~~ Data Types ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		$aReplaceInfo[$iArrayIndex][1] = FileRead("X:\2022_Ontario\SystemIntegrator\PLC_HMI_Code\RichardGroves_Sandbox\Exports\Use_Files\DTs.xml")

;~~~~~~~~~~~~~~~~~ AOIs ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		$aReplaceInfo[$iArrayIndex][2] = FileRead("X:\2022_Ontario\SystemIntegrator\PLC_HMI_Code\RichardGroves_Sandbox\Exports\Use_Files\AOIs.xml")

;~~~~~~~~~~~~~~~~~ Tags ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		$aReplaceInfo[$iArrayIndex][3] &= @CRLF & StringReplace(StringReplace(FileRead("X:\2022_Ontario\SystemIntegrator\PLC_HMI_Code\RichardGroves_Sandbox\Exports\Use_Files\" & $sType & "_Tags.xml"), '[Name]', $sName), '[CLXTagName]', $sName)

;~~~~~~~~~~~~~~~~~ Rungs ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		$aReplaceInfo[$iArrayIndex][4] &= @CRLF & StringReplace(StringReplace(StringReplace(FileRead("X:\2022_Ontario\SystemIntegrator\PLC_HMI_Code\RichardGroves_Sandbox\Exports\Use_Files\" & $sType & "_Rungs.xml"), '[Name]', $sName), '[RungNum]', $aReplaceInfo[$iArrayIndex][5]), '[CLXTagName]', $sName)
		$aReplaceInfo[$iArrayIndex][5] += 1
...
;~ _ArrayDisplay($aReplaceInfo)
	...
	For $x = 1 To UBound($aReplaceInfo) - 1
		$sFilePath = 'X:\2022_Ontario\SystemIntegrator\PLC_HMI_Code\RichardGroves_Sandbox\Imports\Main_' & $aReplaceInfo[$x][0] & '.L5X'
