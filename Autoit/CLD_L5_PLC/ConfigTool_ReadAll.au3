...
HotKeySet('{esc}', '_Exit')
$iPID = Run("C:\Program Files (x86)\AutoIt3\AutoIt3.exe Y:\My_Scripts\CLD_L5_PLC\PopupCloser.au3")

$sConfigToolWorkbookPath = "Y:\My_Scripts\CLD_L5_PLC\Audits\ConfigTools\CA_HBF_B_ConfigTool_20230224.xls"
