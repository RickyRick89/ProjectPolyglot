...
HD_PWD='Y:/School/ECE 530 - Digital Hardware Design/Activities/02/Freq_Div/Freq_Div.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Freq_Div_Board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Freq_Div_Board.tcl
