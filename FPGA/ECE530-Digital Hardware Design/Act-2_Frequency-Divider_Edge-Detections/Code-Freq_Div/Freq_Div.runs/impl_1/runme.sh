...
HD_PWD='Y:/School/ECE 530 - Digital Hardware Design/Activities/02/Freq_Div/Freq_Div.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Freq_Div_Board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Freq_Div_Board.tcl -notrace
