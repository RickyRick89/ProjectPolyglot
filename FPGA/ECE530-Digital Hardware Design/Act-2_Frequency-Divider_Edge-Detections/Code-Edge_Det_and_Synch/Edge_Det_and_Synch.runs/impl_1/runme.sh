...
HD_PWD='Y:/School/ECE 530 - Digital Hardware Design/Activities/02/Edge_Det_and_Synch/Edge_Det_and_Synch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Edge_Det_and_Synch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Edge_Det_and_Synch.tcl -notrace
