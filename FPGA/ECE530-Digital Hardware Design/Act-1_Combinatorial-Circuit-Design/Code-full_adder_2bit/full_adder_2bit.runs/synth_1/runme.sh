...
HD_PWD='Y:/School/ECE 530 - Digital Hardware Design/Activities/01/full_adder_2bit/full_adder_2bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Full_Adder_2Bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Full_Adder_2Bit.tcl
