...
HD_PWD='Y:/School/ECE 530 - Digital Hardware Design/Activities/01/full_adder_2bit/full_adder_2bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Full_Adder_2Bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Full_Adder_2Bit.tcl -notrace
