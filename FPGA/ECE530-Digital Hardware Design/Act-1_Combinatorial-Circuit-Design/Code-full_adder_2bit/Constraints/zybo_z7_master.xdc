...
##Buttons
set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { cin }]; #IO_L12N_T1_MRCC_35 Sch=btn[0]
...
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { cout }]; #IO_0_35 Sch=led[2]
