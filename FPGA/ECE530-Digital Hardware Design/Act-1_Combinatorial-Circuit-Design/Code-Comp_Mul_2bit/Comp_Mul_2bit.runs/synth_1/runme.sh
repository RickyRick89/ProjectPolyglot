...
HD_PWD='Y:/School/ECE 530 - Digital Hardware Design/Activities/01/Comp_Mul_2bit/Comp_Mul_2bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Comp_Mul_2bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Comp_Mul_2bit.tcl
