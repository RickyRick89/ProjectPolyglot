...
HD_PWD='Y:/School/ECE 530 - Digital Hardware Design/Activities/01/Comp_Mul_2bit/Comp_Mul_2bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Comp_Mul_2bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Comp_Mul_2bit.tcl -notrace
