...
HD_PWD='Y:/School/ECE 530 - Digital Hardware Design/Activities/01/Binary_to_BCD/Binary_to_BCD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Binary_to_BCD_Board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Binary_to_BCD_Board.tcl -notrace
