...
HD_PWD='Y:/School/ECE 530 - Digital Hardware Design/Activities/01/Binary_to_BCD/Binary_to_BCD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Binary_to_BCD_Board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Binary_to_BCD_Board.tcl
