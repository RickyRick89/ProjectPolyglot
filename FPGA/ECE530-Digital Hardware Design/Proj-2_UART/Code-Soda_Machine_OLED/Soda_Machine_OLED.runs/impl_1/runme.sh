...
HD_PWD='Y:/School/ECE 530 - Digital Hardware Design/Projects/P2/Soda_Machine_OLED/Soda_Machine_OLED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log soda_machine_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source soda_machine_wrapper.tcl -notrace
