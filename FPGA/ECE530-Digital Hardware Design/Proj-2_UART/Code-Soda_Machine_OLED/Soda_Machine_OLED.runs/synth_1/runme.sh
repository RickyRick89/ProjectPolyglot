...
HD_PWD='Y:/School/ECE 530 - Digital Hardware Design/Projects/P2/Soda_Machine_OLED/Soda_Machine_OLED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soda_machine_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soda_machine_wrapper.tcl
